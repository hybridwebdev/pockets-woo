	...
	<form class="grid columns-1 gap-1 align-items-start" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
		...
		<div class="grid columns-1 columns-lg-2 gap-2 align-items-start">
			...
			<p class='grid columns-1 gap-1'>
				...
				<input type="text" class="form-control" name="account_display_name" id="account_display_name" aria-describedby="account_display_name_description" value="<?php echo esc_attr( $user->display_name ); ?>" aria-required="true" /> <span id="account_display_name_description"><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></em></span>
			</p>
		...
		<div class='d-flex'>
			...
			<button 
				type="submit" 
				class="btn btn-confirm ms-auto p-1 px-3" 
